	...
	<body>
		...
		<div class="container">
			<ul id="list">
				...
				<li id="listComponent"><a href="connection.php">Se connecter</a></li>
				<li id="listComponent"><a href="inscription.php">S'inscrire</a></li>
			</ul>
		</div>
...
Location: ./ProjetWeb/application/views/template.php -->
